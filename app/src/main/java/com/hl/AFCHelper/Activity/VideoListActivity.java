...
import com.hl.AFCHelper.Fragment.VideoListFragment;
...
public class VideoListActivity extends BaseActivity {
    ...
    private ArrayList<Data> mVideoData;
    ...
    protected void initData() {
        ...
        mVideoData = intent.getParcelableArrayListExtra ("videoData");
    ...
    private void getSearchListData(String newText, String sql) {
        ...
        while (cursor.moveToNext ()) {
            ...
            Data videoData = new Data (mid, titleStr, contentStr,imageUrl,videoUrl);
        ...
        bundle.putSerializable ("videoData", mVideoData);
